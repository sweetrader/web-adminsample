  ...
  <div>
    <sticky :class-name="'sub-navbar'">
      <el-row type="flex" align="middle" justify="space-between">
        <p>{{ mchtTextFilter($store.getters.roleInfo) + $t('dashboard.orgDashboardInfo') }}</p>
    ...
    <div v-loading="dataLoading" class="app-container">
      ...
      <el-card class="dashboard_card_style">
        <div class="dashboard_data_contents">
          ...
          <div class="data_wrapper">
            <div class="title_text" align="center">
              {{ $t('dashboard.thisMoNewUser') }}
            </div>
            <count-to :start-val="0" :end-val="data.thisMoNewUser" :duration="3000" class="card-panel-num" align="center"/>
          </div>
          ...
          <div class="data_wrapper">
            <div class="title_text" align="center">
              {{ $t('dashboard.lastMoNewUser') }}
            </div>
            <count-to :start-val="0" :end-val="data.lastMoNewUser" :duration="3000" class="card-panel-num" align="center"/>
          </div>
        </div>
      </el-card>
