    ...
    <el-card class="dashboard_card_style">
      <div class="dashboard_data_contents">
        <div class="data_wrapper">
          ...
          <count-to :start-val="0" :end-val="data.orgMng" :duration="3000" class="card-panel-num" align="center"/>
        </div>
        ...
        <div class="data_wrapper">
          ...
          <count-to :start-val="0" :end-val="data.allPitCard" :duration="3000" class="card-panel-num" align="center"/>
        </div>
        ...
        <div class="data_wrapper">
          ...
          <count-to :start-val="0" :end-val="data.allMcht" :duration="3000" class="card-panel-num" align="center"/>
        </div>
      </div>
    </el-card>
